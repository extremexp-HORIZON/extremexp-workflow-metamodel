...
import eu.extremexp.workflow.metamodel.main.workflow.Array;
import eu.extremexp.workflow.metamodel.main.workflow.AssembledWorflow;
import eu.extremexp.workflow.metamodel.main.workflow.Case;
import eu.extremexp.workflow.metamodel.main.workflow.CompositeWorkflow;
import eu.extremexp.workflow.metamodel.main.workflow.Condition;
import eu.extremexp.workflow.metamodel.main.workflow.ConditionalControlLink;
import eu.extremexp.workflow.metamodel.main.workflow.ConditionalLink;
import eu.extremexp.workflow.metamodel.main.workflow.Control;
import eu.extremexp.workflow.metamodel.main.workflow.ControlLink;
import eu.extremexp.workflow.metamodel.main.workflow.ControlNode;
import eu.extremexp.workflow.metamodel.main.workflow.DataLink;
import eu.extremexp.workflow.metamodel.main.workflow.Event;
import eu.extremexp.workflow.metamodel.main.workflow.EventValue;
import eu.extremexp.workflow.metamodel.main.workflow.ExceptionalLink;
import eu.extremexp.workflow.metamodel.main.workflow.Exclusive;
import eu.extremexp.workflow.metamodel.main.workflow.Experiment;
import eu.extremexp.workflow.metamodel.main.workflow.ExperimentSpace;
import eu.extremexp.workflow.metamodel.main.workflow.ExperimentStep;
import eu.extremexp.workflow.metamodel.main.workflow.ExperimentTask;
import eu.extremexp.workflow.metamodel.main.workflow.Field;
import eu.extremexp.workflow.metamodel.main.workflow.Group;
import eu.extremexp.workflow.metamodel.main.workflow.Inclusive;
import eu.extremexp.workflow.metamodel.main.workflow.InputData;
import eu.extremexp.workflow.metamodel.main.workflow.Interaction;
import eu.extremexp.workflow.metamodel.main.workflow.Join;
import eu.extremexp.workflow.metamodel.main.workflow.Link;
import eu.extremexp.workflow.metamodel.main.workflow.MetaData;
import eu.extremexp.workflow.metamodel.main.workflow.Metric;
import eu.extremexp.workflow.metamodel.main.workflow.MetricKind;
import eu.extremexp.workflow.metamodel.main.workflow.Node;
import eu.extremexp.workflow.metamodel.main.workflow.Operator;
import eu.extremexp.workflow.metamodel.main.workflow.OutputData;
import eu.extremexp.workflow.metamodel.main.workflow.Parallel;
import eu.extremexp.workflow.metamodel.main.workflow.Parameter;
import eu.extremexp.workflow.metamodel.main.workflow.ParameterType;
import eu.extremexp.workflow.metamodel.main.workflow.ParameterValue;
import eu.extremexp.workflow.metamodel.main.workflow.Primitive;
import eu.extremexp.workflow.metamodel.main.workflow.PrimitiveType;
import eu.extremexp.workflow.metamodel.main.workflow.RegularControlLink;
import eu.extremexp.workflow.metamodel.main.workflow.RegularLink;
import eu.extremexp.workflow.metamodel.main.workflow.Structure;
import eu.extremexp.workflow.metamodel.main.workflow.SubstitutedTask;
import eu.extremexp.workflow.metamodel.main.workflow.Task;
import eu.extremexp.workflow.metamodel.main.workflow.TaskConfiguration;
import eu.extremexp.workflow.metamodel.main.workflow.TaskData;
import eu.extremexp.workflow.metamodel.main.workflow.TaskSpecification;
import eu.extremexp.workflow.metamodel.main.workflow.ValueConstraint;
import eu.extremexp.workflow.metamodel.main.workflow.Workflow;
import eu.extremexp.workflow.metamodel.main.workflow.WorkflowFactory;
...
public class WorkflowPackageImpl extends EPackageImpl implements WorkflowPackage {
	 ...
	 * @see eu.extremexp.workflow.metamodel.main.workflow.WorkflowPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(rootEClass, eu.extremexp.workflow.metamodel.main.workflow.ROOT.class, "ROOT", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getROOT_Groups(), this.getGroup(), null, "groups", null, 0, -1,
				eu.extremexp.workflow.metamodel.main.workflow.ROOT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
