...
import eu.extremexp.workflow.metamodel.ge.workflow.UI;
 ...
 * </p>
 * <ul>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getImplementationRef <em>Implementation Ref</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getSubworkflow <em>Subworkflow</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getGenerates <em>Generates</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link eu.extremexp.workflow.metamodel.ge.workflow.impl.TaskImpl#getUi <em>Ui</em>}</li>
 * </ul>
 *
 * @generated
 */
